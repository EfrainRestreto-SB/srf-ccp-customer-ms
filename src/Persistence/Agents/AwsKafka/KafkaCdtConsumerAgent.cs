...
public class KafkaCdtConsumerAgent<TKey, TValue>(IKafkaConsumerConfig kafkaConsumerConfig,
                                                 AWSOptions awsOptions,
                                                 ILogger<KafkaCdtConsumerAgent<TKey, TValue>> logger) 
: IKafkaConsumerAgent<TKey, TValue>
{
    ...
    private readonly ILogger<KafkaCdtConsumerAgent<TKey, TValue>> logger = logger ?? throw new ArgumentNullException(nameof(logger));
