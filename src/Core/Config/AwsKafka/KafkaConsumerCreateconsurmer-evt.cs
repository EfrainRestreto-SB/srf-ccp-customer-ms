...
public class KafkaConsumerCustomertEvtConfig(IOptions<KafkaCustomertEvtJson> options) : IKafkaConsumerConfig
{
    private readonly KafkaCustomertEvtJson config = options.Value;
