...
public class KafkaCustomerProducerAgent<TKey, TValue> : IKafkaProducerAgent<TKey, TValue>, IDisposable
{
    private readonly ILogger<KafkaCustomerProducerAgent<TKey, TValue>> logger;
    ...
    public KafkaCustomerProducerAgent(IKafkaProducerConfig kafkaProducerConfig, AWSOptions awsOptions, ILogger<KafkaCustomerProducerAgent<TKey, TValue>> logger)
    {
